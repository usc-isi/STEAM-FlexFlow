...
def get_route(src, dest, distance_l):
    ...
    # distance_l.sort(key=lambda x: x, reverse = True) # sort according to the distance
...
generate_ring1_task()
arg_topo1 = [[1, 1], [2, 1], [3, 1], [4, 1], [5, 1], [6, 1], [7, 1]] # Ring 2
arg_topo2 = [[1, 8]] # Ring 2
arg_topo3 = [[1, 7], [1,1]] # Ring 3
generate_ring1(arg_topo2)
