...
apps = ["dlrm", "candle"]
#nodes = [8, 16, 32, 128]
bandwidth = [100000, 400000, 800000, 1600000]
#links = [4, 8, 16]
links = [4, 8, 12]
links_fattree = [1, 2, 3] 
...
#intrepid8_nodes = [8]
#intrepid16_nodes = [16]
ideal_nodes = [16, 32, 128]
fattree_nodes = [16, 32, 128]
topoopt_nodes = [16, 32, 128]
sip_ml_nodes = []
intrepid8_nodes = []
intrepid16_nodes = []
#fattree_nodes_allocated = [16, 16, 54, 128]
ideal_nodes_allocated = [16, 32, 128]
fattree_nodes_allocated = [16, 32, 128]
            ...
            for j, n in enumerate(nodes):
                ...
                for b in bandwidth:
                    for i, d in enumerate(links):
                        ...
                        ifile = 'tg.' + topo_file_prefix[t_index] + "." + str(int(b/1000)) + 'G.' + a + str(n) + '.nd' + str(d)
