...
./htsim_ndp_dynexpTopology -cutoff 1500 -rlbflow 0 -cwnd 30 -q 8 -simtime 10.0 -pullrate 0.1 -topfile ./dynexp_N=108_k=12_1path.txt -flowfile ../../jsons/tg.fattree.100G.candle16_nd4_InOrder_david.json
