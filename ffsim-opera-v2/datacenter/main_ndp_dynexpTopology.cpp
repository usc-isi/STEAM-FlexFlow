...
int main(int argc, char **argv) {
    ...
    NdpSinkLoggerSampling sinkLogger = NdpSinkLoggerSampling(timeFromSec(10.), eventlist);
...
// this creates the Expander topology
    ...
    FFApplication app = FFApplication(top, cwnd, pull_rate, cutoff, ndpRtxScanner, sinkLogger, eventlist, ar_strategy);
...
//#endif 
    ...
    cerr << "FinalFinish " << app.final_finish_time << endl;
    cerr << "Done" << endl;
